...
urlpatterns = [
    ...
    re_path(r'^api/(?P<slug>[\w-]+)/project_like/$', views.ProjectLikeToggleAjax.as_view(), name='project_like_toggle_api'),
    ...
    re_path(r'^api/(?P<slug>[\w-]+)/dislike/$', views.ProjectPostDislikeToggleAjax.as_view(), name='post_dislike_toggle_api'),
