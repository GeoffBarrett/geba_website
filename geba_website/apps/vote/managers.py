...
class _VotableManager(models.Manager):
    ...
    def __init__(self, through, model, instance, field_name='votes'):
        # initializing manager parameters
    ...
    @instance_required
    def up(self, user_id):
        # adds a like or dislike vote to the an object
        return self.vote(user_id, action=UP)

    @instance_required
    def down(self, user_id):
        # removes a like or dislike vote from the object
    ...
    def annotate(self, queryset=None, user_id=None,
        ...
        """This will determine any of the objects in the querset are up_voted or down_voted by the user_id
        and then add it temporarily to attributes of the object called is_up_voted or is_down_voted"""
...
class VotableManager(GenericRelation):
    ...
    def __init__(self, through=None, manager=_VotableManager, **kwargs):
        # importing in the scope of __init__ due to the cause of circular dependent imports
